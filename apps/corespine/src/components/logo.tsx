/**
 * corespine brand mark — a left "binding" (the spine) in the theme accent, with
 * indexed rows fading off to the right (the stacked seams of the shared core).
...
export function Logo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" role="img" aria-label="corespine">
      <rect
        x="3"
        y="4"
        width="3.4"
