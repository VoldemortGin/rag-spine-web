/**
 * spineagent brand mark — a left "binding" (the spine) in the theme accent, with
 * indexed rows fading off to the right (the agents / tools stacked off the spine).
...
export function Logo({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" role="img" aria-label="spineagent">
      <rect
        x="3"
        y="4"
        width="3.4"
