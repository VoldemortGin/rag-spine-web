...
const pypiUrl = 'https://pypi.org/project/spineagent/';
    ...
    <main className="flex flex-1 flex-col">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 py-20 sm:py-28">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-7 text-center">
            ...
            <p className="max-w-2xl text-pretty text-base leading-relaxed text-fd-muted-foreground sm:text-lg">
              Agents, tools, and orchestration plus MCP and A2A protocol seams — built on the thin
              shared core corespine and reusing its seam meta-pattern. The default path runs
              offline, import-clean, with no network SDKs.
            </p>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-20 sm:py-24">
        <div className="mb-10 flex flex-col gap-3">
          <SectionLabel>Why spineagent</SectionLabel>
          ...
          <div className="mb-10 flex flex-col gap-3">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-fd-muted-foreground">
              ...
              <span className="font-mono text-fd-foreground">
                Protocol + offline deterministic default + Registry factory + parameterized
                conformance
              </span>
              . Real LLM providers and the MCP / A2A SDKs arrive through optional extras,
              lazy-imported only when you reach for them — so the core stays offline and
              import-clean.
            </p>
          </div>
        </div>
