...
<Callout type="info">
  这个引擎拓扑模型不同于[工作流预览
  v1](/zh/docs/guides/workflows#preview-协议-v1)。`PipelineGraph` 描述已组装的 RAGSpine
...
<Callout type="info">
  `HybridRetriever.topology()`（位于[检索](/zh/docs/guides/retrieval)领域）是对
...
<Cards>
  ...
  <Card
    title="工作流预览"
    href="/zh/docs/guides/workflows#preview-协议-v1"
