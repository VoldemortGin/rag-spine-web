...
- **Fact extractors** (`xlsx_extractor`, `pptx_extractor`) produce
  [`Fact`](/docs/guides/storage#the-fact-dataclass) objects directly for known schemas
...
<Cards>
  ...
  <Card title="Storage guide — the Fact dataclass" href="/docs/guides/storage" />
  <Card title="StyledGrid IR" href="/docs/guides/extraction#the-styledgrid-ir" />
