...
`None` and `cf_affected` cells. See the [StyledGrid IR concept](/docs/concepts/styled-grid).
...
revisions. See [color semantics](/docs/concepts/color-semantics).
...
<Cards>
  ...
  <Card title="Concept: StyledGrid IR" href="/docs/concepts/styled-grid" />
