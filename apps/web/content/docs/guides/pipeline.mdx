...
<Callout type="info">
  ...
  v1](/docs/guides/workflows#preview-protocol-v1). `PipelineGraph` describes assembled RAGSpine
...
<Callout type="info">
  `HybridRetriever.topology()` (in the [retrieval](/docs/guides/retrieval) domain) is a thin
...
<Cards>
  ...
  <Card
    ...
    href="/docs/guides/workflows#preview-protocol-v1"
