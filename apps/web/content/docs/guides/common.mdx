...
[narrative ingestion](/docs/guides/ingestion#narrative-ingestion) path applies and that
[RESTRICTED isolation](/docs/concepts/restricted-isolation) downstream depends on. Levels are
...
[fact store](/docs/guides/storage#dim_key-the-upsert-key): `FY` (`FY2024` / `2024`),
...
<Cards>
  ...
  <Card title="Ingestion guide — sensitivity on ingest" href="/docs/guides/ingestion" />
  <Card title="Concept: RESTRICTED isolation" href="/docs/concepts/restricted-isolation" />
