...
[叙事摄取](/zh/docs/guides/ingestion#叙事摄取)路径应用，也是下游
[RESTRICTED 隔离](/zh/docs/concepts/restricted-isolation)所依赖的基础。级别是
...
[事实存储](/zh/docs/guides/storage#dim_key--upsert-键)所使用的一致：`FY`（`FY2024` / `2024`）、
...
<Cards>
  ...
  <Card title="摄取指南——摄取时的敏感度" href="/zh/docs/guides/ingestion" />
  <Card title="概念：RESTRICTED 隔离" href="/zh/docs/concepts/restricted-isolation" />
