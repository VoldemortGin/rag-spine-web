...
| #   | Decision                                                                          | ADR                              |
| --- | --------------------------------------------------------------------------------- | -------------------------------- |
| 1   | Audience = general-purpose **OSS library** for others to build on                 | [0003](/docs/decisions/adr-0003) |
| 2   | **Full generality** via `DomainProfile`; finance is one bundled example           | [0004](/docs/decisions/adr-0004) |
| 3   | **Lean core + experimental/extras isolation**; no dormant code in core            | [0005](/docs/decisions/adr-0005) |
| 4   | Quality = **invariants as property tests** + one real retrieval benchmark         | [0006](/docs/decisions/adr-0006) |
| 5   | Multilingual = **architect-for-5, ship-2** (Chinese + English), locale packs      | [0007](/docs/decisions/adr-0007) |
| 6   | Prompts = packaged `ragspine/prompts/<locale>/` behind a `PromptRegistry`         | [0008](/docs/decisions/adr-0008) |
| 7   | framework-free = **no framework lock-in + permissive-license-only**; lean default | [0009](/docs/decisions/adr-0009) |
| 8   | Intent parsing = **deterministic security gate** + pluggable `IntentParser`       | [0010](/docs/decisions/adr-0010) |
