...
Part of the [0002](/en/docs/decisions/adr-0002) product direction. Gated by [0003](/en/docs/decisions/adr-0003).
...
([0003](/en/docs/decisions/adr-0003)), "general" must be true of _both_ channels.
...
- Forces the intent parser to stop hardcoding finance dimensions → [0010](/en/docs/decisions/adr-0010).
