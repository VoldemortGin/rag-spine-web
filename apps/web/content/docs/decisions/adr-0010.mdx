...
Part of the [0002](/docs/decisions/adr-0002) product direction. Forced by [0004](/docs/decisions/adr-0004) and [0007](/docs/decisions/adr-0007).
...
prior decisions break a pure rule parser: full generality ([0004](/docs/decisions/adr-0004))
means arbitrary user-defined dimensions a finance-tuned parser can't read, and
multilingual ([0007](/docs/decisions/adr-0007)) makes
...
- **Intent extraction** becomes an **`IntentParser` Protocol** with a default zero-LLM,
  ...
  [0009](/docs/decisions/adr-0009)) and an optional LLM-classifier
