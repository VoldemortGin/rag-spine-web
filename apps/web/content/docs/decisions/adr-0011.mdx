...
and [0005](/docs/decisions/adr-0005) (lean core).
...
3. SDK isolation via `Protocol` + lazy import (per [0009](/docs/decisions/adr-0009) / [0005](/docs/decisions/adr-0005)), not a `ports/` +
