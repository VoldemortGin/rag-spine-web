...
- "General-purpose" must be **proven**, forcing [0004](/en/docs/decisions/adr-0004)
  (full generalization) and a second-domain example.
- Dormant/half-wired code becomes a credibility liability → [0005](/en/docs/decisions/adr-0005).
- The `service/` layer is reframed as a reference deployment example, not a product.
- Contributor surface matters: locale packs ([0007](/en/docs/decisions/adr-0007)),
