...
- Locale packs are a concrete test of the `Protocol` extension story for outsiders,
  reinforcing the OSS-library identity ([0003](/en/docs/decisions/adr-0003)).
- Locale-keyed prompt templates are realized by [0008](/en/docs/decisions/adr-0008).
- Per-language intent vocabulary interacts with the parser decision in [0010](/en/docs/decisions/adr-0010).
