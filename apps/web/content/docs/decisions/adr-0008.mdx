...
(with placeholders) × a **locale** ([0007](/docs/decisions/adr-0007))
× **`DomainProfile` values** ([0004](/docs/decisions/adr-0004)), and the
...
[0003](/docs/decisions/adr-0003)) would not get it.
...
- A locale pack ([0007](/docs/decisions/adr-0007)) is partly
