...
See [Anti-fabrication](/en/docs/concepts/anti-fabrication).
...
composite questions — compared and merged. See [Dual channel](/en/docs/concepts/dual-channel).
...
answer. Carried end-to-end, never dropped. See [Provenance](/en/docs/concepts/provenance).
