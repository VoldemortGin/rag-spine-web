...
<Cards>
  <Card title="Common" href="/en/docs/guides/common" />
  <Card title="Ingestion" href="/en/docs/guides/ingestion" />
  <Card title="Retrieval" href="/en/docs/guides/retrieval" />
  <Card title="Evaluation" href="/en/docs/guides/evaluation" />
  <Card title="Workflows" href="/en/docs/guides/workflows" />
  <Card title="Service" href="/en/docs/guides/service" />
</Cards>
